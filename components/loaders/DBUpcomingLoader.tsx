...
const DBUpcomingLoader = () => {
  return (
    <div className="flex flex-col items-start animate-pulse border-[1px] border-[#E4E4E7] py-3 px-5 gap-5 w-full">
      <div className="h-[30px] w-[250px] bg-gray-300 rounded-full mr-2"></div>
